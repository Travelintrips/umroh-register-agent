          ...
          <CardContent className="pt-6">
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <h2 className="text-2xl font-bold mb-2">
                Pesanan Personal Berhasil Dibuat!
              </h2>
              <p className="text-gray-600 mb-6">
                Terima kasih telah membuat pesanan personal. Kami akan
                menghubungi Anda segera untuk konfirmasi.
              </p>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-lg sm:text-xl text-gray-600">
            {showSummary ? "Ringkasan & Pembayaran" : "Form Booking Personal"}
          </p>
        </div>
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row justify-between gap-4 pt-6">
                    ...
                    >
                      ...
                      {isSubmitting ? "Memproses..." : "Buat Pesanan Personal"}
                    </Button>
                  </div>
                </form>
              </Form>
...
export default BookingFormPersonal;
