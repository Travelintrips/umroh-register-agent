...
const BookingForm = () => {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      const generatedBookingCode = `HSA-AGENT-${Date.now()}`;
      ...
      const selectedBank =
        selectedPaymentMethod === "bank_transfer" ? null : null; // No bank selection in agent form
      const bankName = null;
      ...
      const bookingData = {
        ...
        passengers: 1, // Agent booking is typically for 1 passenger
        additional_notes: formData.catatan_tambahan,
        price: totalPrice, // Basic price
        total_amount: totalPrice, // Total amount (no discounts for agent)
        ...
        bank_name: bankName,
        // Add discount information (null for agent bookings)
